...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "2 bifes",
    item2: "Sal a gosto",
    item3: "2 cabeças de alho",
    item4: "1/2 xícara de água",
    item5: "4 colheres de maionese",
    item6: "1 cebola grande picada em rodelas",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Tempere e frite o bife ao seu gosto em uma frigideira.",
    step2: "Após resguarde os bifes em um refratário ou travessa.",
    step3:
      "Na mesma panela dos bifes doure a cebola picada em rodelas, adicione o alho, após adicione a água.",
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_bife.png")}
