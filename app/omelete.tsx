...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item2: "Sal a gosto",
    item3: "50 ml de óleo",
    item4: "1 lata de milho",
    item5: "1 cebola picada",
    item6: "4 cenouras raladas",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma frigideira média, coloque o óleo.",
    step2: "Acrescente a cebola picada e dê uma fritada.",
    step3: "Depois, coloque as cenouras raladas e o milho.",
    step4:
      "Para dar mais sabor, coloque o sal a gosto e mexa tudo por três minutos. ",
    step5:
      "Após mexer, tampe a frigideira e deixe cozinhar no bafo por mais seis minutos. Dependendo da potência do seu fogão, fique de olho para não queimar. ",
    step6:
      "Em seguida, retire a tampa, coloque os ovos e mexa bem. Assim que o ovo estiver bem frito, retire e sirva-se. ",
  };
