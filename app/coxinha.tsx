...
export default function CoxinhaDeFrango() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "25 ml de leite",
    item2: "Tempero a gosto",
    item3: "Meio peito de frango",
    item4: "50g de farinha de trigo",
    item5: "Requeijão (opcional)",
    item6: "1 colher de sopa de manteiga",
    item7: "1 batata média cozida e amassada",
