...
export default function App() {
  ...
  const [adShown, setAdShown] = useState(false); // controla se o anúncio já foi mostrado
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item6: "1 xícara de queijo cheddar ralado (ou processado tipo cremoso)",
    item7:
      "(Opcional) Pimenta-do-reino, noz-moscada ou páprica para sabor extra",
  };

  // 🔵 mesma lógica das bolinhas + anúncio quando todos forem marcados
  ...
  // 🛒 salvar lista de compras + anúncio recompensa
  const salvarListaDeCompras = async () => {
    ...
    const fileUri = FileSystem.documentDirectory + "lista_de_compras_nacho.txt";
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalTexto}>
              ...
              devem ser limpos e colocados no lixo reciclável.{"\n\n"}
              <Text style={{ fontWeight: "bold" }}>Vidros:</Text> recicláveis,
              mas quebrou? Embale bem.{"\n\n"}
              <Text style={{ fontWeight: "bold" }}>Papéis:</Text> recicláveis se
              não estiverem engordurados.{"\n\n"}
              <Text style={{ fontWeight: "bold" }}>Óleo:</Text> guarde em
              garrafa e leve a um ponto de coleta.{"\n\n"}
