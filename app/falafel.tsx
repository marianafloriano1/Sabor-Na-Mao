...
export default function FalafelVegano() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "1/2 cebola média picada.",
    item5: "3 colheres de sopa de azeite.",
    item6: "2 colheres de sopa de farinha de trigo.",
    item7: "1-2 colheres de chá de sal.",
    item8: "1 colher de sopa de cominho.",
    item9: "1 colher de sopa de suco de limão.",
    item10: "1/4 copo folhas de hortelã.",
    item11: "1 copo de grão de bico seco.",
    item12: "1 copo de salsinha fresca picada.",
    item13: "4 colheres de sopa de azeite de oliva.",
    item14: "3/4 copo de tahine (pasta de gergelim).",
    item15: "1 e 1/2 lata de leite condensado",
  };
