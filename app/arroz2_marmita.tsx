...
// Funções de anúncio e recompensa (mesmo estilo do ArrozNatalino)
...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "2 ovos",
    item2: "1 colher (sopa) de azeite",
    item3: "1 talo de alho-poró em rodelas",
    item4: "1 abobrinha picada em tiras grossas",
    item5: "1 xícara de arroz integral cozido",
    item6: "1/2 xícara de repolho picado grosseiramente",
    item7: "Sal e pimenta-do-reino a gosto",
    item8: "Cheiro-verde ou salsinha para finalizar",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Coloque os ovos em água fervente e cozinhe por 6 a 7 minutos.",
  ...
  // Alterna check e exibe anúncio quando todos forem marcados
  ...
  // Salvar e compartilhar lista de compras com recompensa
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_arroz_legumes.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_arroz_marmita2.png")}
          ...
          <View style={styles.tituloContainer}>
            ...
            >
              ...
              <Text style={styles.paragraph}>
                ARROZ COM LEGUMES E OVO COZIDO
              </Text>
            </TouchableOpacity>
          </View>
...
// Mantive os estilos do seu código original
