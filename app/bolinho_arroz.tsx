...
export default function BolinhoDeArroz() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "Sal",
    item2: "3 ovos",
    item3: "1/2 xícara (chá) de leite",
    item4: "1/2 xícara (chá) de farinha de trigo",
    item5: "1/2 xícara (chá) de queijo ralado",
    item6: "1/2 xícara (chá) de amido de milho",
    item7: "1 colher (sopa) de fermento em pó",
    item8: "2 xícaras de arroz cozido",
    item9: "2 colheres (sopa) de cheiro-verde picado",
  };
  ...
  // Alterna bolinhas ✓ / ◯ e mostra anúncio quando tudo for marcado
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalTexto}>
              ...
              sacos, tampas e garrafas devem ser limpos e colocados no lixo reciclável.{"\n\n"}
              ...
              papel toalha (se seco e limpo), embalagens de papel e papelão vão para a
              reciclagem.{"\n\n"}
