...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "5 filés de frango",
    item2: "1/2 xícara de agua",
    item3: "Óleo para fritar",
    item4: "1 xícara de farinha de trigo",
    item5: "1 pitada de pimenta do reino",
    item6: "Tempero completo (tipo sabor ami)",
    item7: "1 e 1/2 xícaras de farinha de rosca",
  };
