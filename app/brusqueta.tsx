...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 dente de alho",
    item2: "Azeite a gosto",
    item3: "1 baguete pequena",
    item4: "2 ramos de manjericão",
    item5: "2 tomates italianos grandes e bem maduros",
    item6: "Sal e pimenta-do-reino a gosto",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Corte a baguete em fatias de 1 cm.",
