...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "1 colher (sopa) de água",
    item5: "3 colheres (sopa) de água",
    item6: "4 colheres (sopa) de mel",
    item7: "1 colher (chá) de gengibre ralado",
    item8: "2 colheres (sopa) de amido de milho",
    item9: "meia xícara (chá) de suco de abacaxi",
    item10: "meia colher (sopa) de vinagre de arroz",
    item11: "3 colheres (sopa) de molho de soja (shoyu)",
    item12: "4 colheres (sopa) cebolinha verde picada",
    item13: "500 g de coxas de frango \nsem osso ou pedaços de peito de frango",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma frigideira, aqueça o azeite e doure bem o frango.",
    step2: "Acrescente o sal, o alho e o gengibre e misture bem.",
    step3:
      "Acrescente o shoyu, a água, o vinagre e o suco e abacaxi. Quando ferver, adicione o amido dissolvido em 1 colher (sopa) de água e mexa bem até que o molho fique espesso.",
    step4: "Acrescente o mel e deixe ferver até cozinhar os frangos.",
    step5:
      "Coloque cebolinha verde e deixe cozinhando até o molho obter uma consistência mais espessa. Sirva com gergelim branco polvilhado.",
  };
