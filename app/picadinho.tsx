...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "2 dentes de alho picados",
    item2: "4 colheres (sopa) de água",
    item3: "2 colheres (sopa) de maionese",
    item4: "1 colher (sopa) de óleo ou azeite",
    item5: "1 xícara (chá) de rúcula picada",
    item6: "Sal e pimenta-do-reino a gosto",
    item7: "4 colheres (sopa) de mostarda amarela",
    item8: "500g de coxão mole ou aranha do contrafilé em cubos",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Retire, tempere com sal, pimenta e mantenha aquecido em uma travessa.",
    ...
    step6:
      "Despeje sobre a carne reservada, polvilhe com a rúcula picada e sirva.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_picadinho_carne.txt";
