...
export default function App() {
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri = FileSystem.documentDirectory + "lista_de_compras_chaHibisco.txt";
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={() => toggleCheckWithAd("step1")}>
            <Text style={styles.topicos}>
              ...
              Leve a água ao fogo até ferver. Desligue o fogo e adicione as flores de hibisco (ou o sachê).
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheckWithAd("step2")}>
            <Text style={styles.topicos}>
              {checkedItems.step2 ? <Text style={styles.check}>✓ </Text> : <Text style={styles.bolinha}>◯ </Text>}
              Se quiser, acrescente também um pedaço de canela em pau, gengibre ou casca de laranja para dar um aroma especial.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheckWithAd("step3")}>
            <Text style={styles.topicos}>
              {checkedItems.step3 ? <Text style={styles.check}>✓ </Text> : <Text style={styles.bolinha}>◯ </Text>}
              Tampe e deixe em infusão por 5 a 10 minutos. Coe (se usar as flores soltas) e sirva quente ou gelado.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheckWithAd("step4")}>
            <Text style={styles.topicos}>
