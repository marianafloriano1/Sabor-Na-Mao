...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 lata de sardinha",
    item2: "1 tomate picado",
    item3: "1/2 cebola picada",
    item4: "1/2 cenoura ralada",
    item5: "1/2 abobrinha ralada",
    item6: "Sal e temperos a gosto",
    item7: "200g de macarrão (parafuso ou penne)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Cozinhe o macarrão conforme as instruções da embalagem.",
    step2:
      "Em uma panela, refogue a cebola, adicione o tomate, cenoura, abobrinha e deixe amolecer.",
    step3:
      "Junte a sardinha (com um pouco do óleo ou sem, como preferir), desfie e misture bem.",
