...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item1: "1 colher de sopa de queijo cottage",
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Em um processador de alimentos, coloque o queijo cottage, a cenoura ralada, uma pitada de sal e a pimenta-do-reino a gosto. Bata até obter uma mistura homogênea e cremosa.",
    step3:
      "Pegue as fatias de pão integral e espalhe uma camada generosa dessa pastinha sobre cada uma delas.",
    step4:
      "Sobre uma das fatias, disponha também os brotos de alfafa ou folhas de alface, o frango grelhado e as fatias de tomate.",
    step5:
      "Coloque a outra fatia de pão por cima, pressionando levemente para fechar e para que tudo fique bem firme. Sirva e aproveite! Se preferir, corte ao meio para facilitar na hora de comer.",
  };
