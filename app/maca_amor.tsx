...
export default function MacasDoAmor() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "12 maçãs",
    item2: "1 kg de açúcar",
    item3: "500 ml de água",
    item4: "1 colher (sopa) de \nvinagre",
    item5: "Corante vermelho (pó ou líquido)",
    item6: "Palitos de sorvete da sua preferência",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_maça_amor.txt";
