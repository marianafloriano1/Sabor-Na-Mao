...
// Funções de anúncio e recompensa (simuladas aqui, substitua pelos seus arquivos reais)
...
export default function App() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "Açúcar ou mel a gosto (opcional)",
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri = FileSystem.documentDirectory + "lista_de_compras_sucoLimao.txt";
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={() => toggleCheckWithAd("step1")}>
            <Text style={styles.topicos}>
              ...
              Lave bem os limões. Corte os limões ao meio e esprema o suco com um espremedor.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheckWithAd("step2")}>
            <Text style={styles.topicos}>
              {checkedItems.step2 ? <Text style={styles.check}>✓ </Text> : <Text style={styles.bolinha}>◯ </Text>}
              Coe o suco para remover sementes e parte do bagaço. Em uma jarra, misture o suco com a água gelada.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheckWithAd("step3")}>
            <Text style={styles.topicos}>
              {checkedItems.step3 ? <Text style={styles.check}>✓ </Text> : <Text style={styles.bolinha}>◯ </Text>}
              Adoce a gosto com açúcar, mel ou adoçante. Adicione gelo e mexa bem. Para um toque especial, adicione folhas de hortelã ou um pedacinho de gengibre ralado.
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
