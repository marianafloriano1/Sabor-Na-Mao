...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "4 ovos",
    item2: "375 g de ricota esfarelada",
    item3: "5 ml de essência de baunilha",
    item4: "5 ml de suco de limão-taiti",
    item5: "25 g de adoçante culinário em pó",
    item6: "120 g de biscoito diet triturado",
    item7: "280 g de geleia de goiaba diet",
    item8: "400 g de iogurte natural desnatado",
    item9: "50 g de pasta de amendoim integral (sem açúcar)",
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.tituloContainer}>
            <TouchableOpacity
              ...
              onPress={() =>
                nav.navigate("restricoes", { categoria: "diabete" })
              }
            >
