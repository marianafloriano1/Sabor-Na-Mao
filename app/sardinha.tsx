...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "3 limões (suco)",
    item4: "4 dentes de alho amassado",
    item5: "1 kg de sardinha limpa e fresca",
    item6: "2 xícaras (chá) de fubá ou farinha de trigo",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step3:
      "Tempere as sardinhas com sal, alho amassado e o suco de limão, depois de 5 minutos mergulhadas, passe no fubá ou na farinha de trigo e frite no óleo.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri = FileSystem.documentDirectory + "lista_de_sardinha.txt";
