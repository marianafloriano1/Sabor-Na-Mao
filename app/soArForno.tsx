...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item5: "1 xícara de queijo muçarela ralado",
    item6: "1 caixinha de creme de leite (200g)",
    item7: "1 copo de requeijão (opcional)",
    item8: "1 tomate picado ou 1/2 lata de molho de tomate",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_arroz_de_forno.txt";
