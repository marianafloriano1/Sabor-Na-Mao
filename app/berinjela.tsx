...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "1 cenoura ralada",
    item5: "Sal e azeite a gosto",
    item6: "500g de carne moída",
    item7: "1 xícara (chá) de queijo mussarela ralado",
    item8: "1/2 xícara (chá) de azeitona verde picada",
    item9: "cheiro-verde picado a gosto",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Lave as berinjelas e corte ao meio, no sentido do comprimento.",
    step2:
      "Faça cortes superficiais com uma faca sobre a polpa, polvilhe com sal e regue com azeite.",
    step3:
      "Coloque em uma fôrma e leve ao forno médio (180º C), preaquecido, por 10 minutos.",
    step4:
      "Retire, deixe amornar, retire parte da polpa com uma colher e reserve. ",
    step5:
      "Para o recheio, aqueça uma panela com o azeite, em fogo médio, e frite a carne moída e a cebola até dourarem. ",
    step6:
      "Adicione o tomate, a azeitona, a polpa da berinjela reservada e refogue por 3 minutos. ",
    step7:
      "Acrescente a cenoura, tempere com sal e cheiro-verde, misture e desligue o fogo. ",
    step8:
      "Divida o recheio entre as metades das berinjelas, polvilhe com a mussarela e coloque em uma fôrma, uma ao lado da outra.",
    step9:
      "Leve ao forno médio (180º C), preaquecido, por 10 minutos ou até gratinar. ",
