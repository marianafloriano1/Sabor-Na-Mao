...
export default function ComidasInfantis() {
  ...
  const [modalType, setModalType] = useState<"vegano" | "vegetariano" | null>(
    null
  );
  const route = useRoute<any>();

  React.useEffect(() => {
    if (route.params?.categoria === "vegetariano") {
      setShowVege(true);
      setShowVeg(false);
    } else if (route.params?.categoria === "vegano") {
      setShowVeg(true);
      setShowVege(false);
    } else {
      // padrão
          ...
          {showVege && (
            <>
              ...
              >
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/109836/pexels-photo-109836.jpeg?auto=compress&cs=tinysrgb&w=600",
                  }}
              ...
              <TouchableOpacity
                style={styles.cardD}
                onPress={() => nav.navigate("hamburguer")}
              >
                <ImageBackground
                  source={require("../assets/images/fundo_dietas.png")}
                  style={styles.backgroundImage}
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/3607284/pexels-photo-3607284.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={styles.card}
                onPress={() => nav.navigate("bolinha_queijo")}
              >
                <ImageBackground
                  source={require("../assets/images/fundo_dietas.png")}
                  style={styles.backgroundImage}
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/17132215/pexels-photo-17132215/free-photo-of-comida-alimento-refeicao-restaurante.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={styles.cardD}
                onPress={() => nav.navigate("torta_vegetariano")}
              >
                <ImageBackground
                  source={require("../assets/images/fundo_dietas.png")}
                  style={styles.backgroundImage}
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/5852252/pexels-photo-5852252.jpeg?auto=compress&cs=tinysrgb&w=600",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
          ...
          {showVeg && (
            <>
              ...
              >
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/3590401/pexels-photo-3590401.jpeg?auto=compress&cs=tinysrgb&w=600",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={styles.card}
                onPress={() => nav.navigate("almondegas")}
              >
                <ImageBackground
                  source={require("../assets/images/fundo_dietas.png")}
                  style={styles.backgroundImage}
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/16461745/pexels-photo-16461745/free-photo-of-copo-taca-caneca-jantar.jpeg?auto=compress&cs=tinysrgb&w=600",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
              ...
              >
                ...
                <Image
                  source={{
                    uri: "https://images.pexels.com/photos/6252726/pexels-photo-6252726.jpeg?auto=compress&cs=tinysrgb&w=600",
                  }}
                  style={styles.cardImage}
                />
              </TouchableOpacity>
