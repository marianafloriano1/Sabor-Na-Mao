...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item5: "2 batatas médias picadas",
    item6: "1 peito de frango em cubos",
    item7: "Azeitonas verdes a gosto",
    item8: "Sal e pimenta-do-reino a gosto",
    item9: "1 colher (sopa) de manteiga ou margarina",
    item10: "Páprica doce ou defumada (opcional)",
    item11: "Ervas frescas (como dill, salsa ou coentro)",
    item12: "1/4 de xícara de leite (ou mais, conforme a textura desejada)",
    item13: "Folhas de manjericão roxo (opcional para decorar)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Preaqueça o forno a 200°C.",
    step2: "Misture as batatas e cenouras com azeite, sal, pimenta e páprica.",
    step3:
      "Em outra tigela, tempere os cubos de frango com azeite, sal e pimenta.",
    step4:
      "Disponha tudo em uma assadeira (pode ser junto ou separado) e leve ao forno por cerca de 30 minutos, mexendo na metade do tempo, até dourar.",
    step5:
      "Cozinhe as batatas descascadas em água com sal até ficarem bem macias.",
    step6:
      "Amasse-as bem e adicione a manteiga e o leite aos poucos, mexendo até virar um purê cremoso.",
    step7: "Acerte o sal.",
    step8:
      "Em um recipiente ou marmita, coloque uma porção de purê, o frango com os legumes por cima e decore com as ervas frescas e azeitonas.",
