...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "3 ovos",
    item2: "1 xícara de arroz",
    item3: "1/4 de pimentão picado",
    item4: "1/2 cenoura em cubinhos",
    item5: "1/4 de xícara de ervilha",
    item6: "Óleo para refogar",
    item7: "Cheiro-verde e sal a gosto",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Bata os ovos com sal e cheiro-verde, e faça uma omelete grande ou duas pequenas.",
    step3:
      "Monte a marmita com uma porção de arroz e a omelete por cima ou ao lado.",
  };
  ...
  // Função para salvar e compartilhar lista de compras
