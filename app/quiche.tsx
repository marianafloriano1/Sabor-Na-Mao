...
export default function QuicheDeLegumes() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "1 pacote de massa folhada",
    item5: "2 colheres (sopa) de cheiro-verde picado",
    item6: "3 colheres (sopa) de queijo parmesão ralado",
    item7: "1/2 xícara (chá) de queijo provolone ralado",
    item8: "1/2 xícara (chá) de tomate seco picado",
    item9: "1 xícara (chá) de queijo mussarela ralado",
    item10: "1/2 xícara (chá) de brócolis cozido e picado",
    item11: "Pimenta-do-reino e noz-moscada a gosto",
  };
