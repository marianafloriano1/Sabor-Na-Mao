...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1/2 xícara (chá) de açúcar",
    item4: "1/2 colher (chá) de fermento em pó",
    item5: "1 xícara (chá) de farinha de trigo",
    item6: "3 colheres (sopa) de achocolatado em pó",
    item7: "Margarina e farinha de trigo para untar",
    item8: "3 colheres (sopa) de manteiga ou margarina em temperatura ambiente",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Adicione a farinha e o achocolatado peneirados e misture até homogeneizar.",
    step3: "Acrescente o fermento e misture delicadamente.",
    step4:
      "Despeje a massa até a metade da capacidade de uma caneca de 250ml e leve ao forno micro-ondas, em temperatura média, por 3 minutos.",
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_bolinho_doce.txt";
