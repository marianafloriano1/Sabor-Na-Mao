...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 gema",
    item2: "2 colheres (sopa) de açúcar",
    item3: "5 colheres (sopa) de margarina",
    item4: "2 xícaras (chá) de farinha de trigo",
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Abra a massa com um rolo, e, forre o fundo e as laterais de forminhas para empada.",
    step3: "Coloque o leite condensado até um pouco mais do meio da forminha.",
    step4:
      "Leve ao forno médio, preaquecido, por 40 minutos ou até dourar levemente.",
 ...
 const toggleCheckWithAd = (key: string) => {
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_empada_doce.txt";
