...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1 xícara de água.",
    item4: "Óleo para fritar.",
    item5: "1 colher de sopa de açúcar.",
    item6: "Açúcar para polvilhar.",
    item7: "1 xícara de farinha de trigo.",
    item8: "1 colher de chá de canela em pó (opcional).",
  };
