...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item2: "2 fatias de queijo mussarela",
    item3: "1 colher de sopa de maionese",
    item4: "1 colher de sopa de molho de tomate",
    item5: "3 colheres de sopa de frango cozido",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Abra a massa de Rap10 e espalhe o molho de tomate por cima.",
    step2: "Coloque o frango e espalhe a maionese.",
    step3:
      "Coloque as fatias de queijo mussarela cortada em pedaços finos ou ralada.",
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_rap10.png")}
