...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "meia colher (sopa) de sal",
    item2: "1 colher (chá) de MAGGI® Fondor",
    item3: "1 colher (sopa) de margarina",
    item4: "2 colheres (sopa) de requeijão",
    item5: "1 e meia xícara (chá) de leite ",
    item6: "250 g de macarrão de sua preferência",
    item7: "meia colher (sopa) de farinha de trigo",
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step3:
      "Em uma panela derreta a margarina, acrescente e farinha e misture bem.",
    step4: "Junte o leite aos poucos, mexendo sempre, para não formar grumos.",
    step5:
      "Tempere com o MAGGI Fondor e cozinhe em fogo baixo, sem parar de mexer, até começar a engrossar.",
    step6: "Junte o requeijão, o espinafre e deixe o requeijão derreter.",
    step7:
      "Escorra o macarrão, coloque em um recipiente, cubra com o molho e sirva a seguir.",
  };
          ...
          <View style={styles.tituloContainer}>
            ...
            >
              ...
              <Text style={styles.paragraph}>
                MACARRÃO COM MOLHO BRANCO E ESPINAFRE
              </Text>{" "}
            </TouchableOpacity>
          </View>
