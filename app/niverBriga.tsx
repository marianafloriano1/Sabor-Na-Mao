...
export default function App() {
  ...
  const stepsMap: { [key: string]: string } = {
    step1:
      "Em uma panela, coloque o leite condensado, a manteiga e o chocolate em pó. Misture bem antes de levar ao fogo.",
    step2:
      "Cozinhe em fogo baixo, mexendo sempre, até a mistura desgrudar do fundo da panela — cerca de 10 a 12 minutos.",
    step3:
      "Transfira para um prato untado com manteiga e deixe esfriar completamente antes de enrolar.",
    step4:
      "Unte as mãos com manteiga, faça bolinhas e passe no granulado. Coloque em forminhas de papel.",
  };

  const [adShown, setAdShown] = useState(false);

  // Toggle com anúncio no fim
