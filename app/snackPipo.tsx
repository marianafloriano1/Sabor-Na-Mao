...
export default function App() {
  ...
  // MESMA LÓGICA DAS BOLINHAS COM ANÚNCIO
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_pipoca.txt";
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.botoesContainer}>
        ...
        {/* Botão da lista com anúncio de recompensa */}
        <TouchableOpacity
