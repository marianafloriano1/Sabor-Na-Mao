...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "Orégano",
    item2: "8 filés de merluza",
    item3: "Azeite para untar",
    item4: "1 pimentão \n(cortado em rodelas)",
    item5: "1 cebola (cortada em rodelas)",
    item6: "4 batatas cruas (em rodelas, sem casca)",
    item7: "1/2 lata de molho de tomate de boa qualidade",
    item8: "2 tomates (cortados em rodelas - as sementes ficam à preferência)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Tempere os filés à seu gosto e reserve por 10 minutos.",
    step2:
          ...
          <View style={styles.tituloContainer}>
            ...
            >
              ...
              <Text style={styles.paragraph}>
                FILÉ DE MERLUZA COM BATATAS AO FORNO
              </Text>{" "}
            </TouchableOpacity>
          </View>
