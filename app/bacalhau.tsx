...
// Importar funções de anúncio e recompensa, caso queira exibir anúncios
...
export default function BacalhauAoForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item5: "1 pimentão",
    item6: "Leite de coco",
    item7: "1 kg de bacalhau",
    item8: "1/2 kg de cenoura",
    item9: "1/2 kg de batata",
    item10: "2 cebolas grandes",
    item11: "Azeite de oliva",
    item12: "2 tomates (vermelho e/ou amarelo)",
    item13: "1 colher (sopa) de extrato de tomate",
  };
