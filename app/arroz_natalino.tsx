...
// Funções de anúncio e recompensa
...
export default function ArrozNatalino() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item6: "1 colher (sopa) de óleo",
    item7: "3 xícaras de arroz cozido",
    item8: "Pimenta-do-reino a gosto",
    item9: "Salsa e cebolinha a gosto",
    item10: "1 cebola média picada em rodelas",
    item11: "2 colheres (sopa) de molho de tomate",
    item12: "1 peito de frango cozido \ne desfiado",
    item13: "1/2 xícara de queijo mussarela ralado",
    item14: "1 lata de seleta de legumes (milho, ervilha, batata, cenoura etc)",
  };
  ...
  // Função para alternar checks e exibir anúncio quando todos forem marcados
  ...
  // Função para salvar e compartilhar lista de compras com recompensa
